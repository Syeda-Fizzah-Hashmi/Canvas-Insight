...
public class PaintView extends View {
    ...
    public void saveImage () {
        ...
        System.out.print(sdDirectory);
        File subDirectory = new File(sdDirectory.toString() + "/Paint/Person");
        ...
        if (subDirectory.exists()) {
            ...
            image = new File(subDirectory, "/person_drawing_" + (count + 1) + ".jpg");
    ...
    public void saveImagehouse () {

        int count = 0;

        File sdDirectory = Environment.getExternalStorageDirectory();
        System.out.print(sdDirectory);
        File subDirectory = new File(sdDirectory.toString() + "/Paint/House");
        ...
        if (subDirectory.exists()) {
            ...
            image = new File(subDirectory, "/house_drawing_" + (count + 1) + ".jpg");
            FileOutputStream fileOutputStream;
